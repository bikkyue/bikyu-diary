...
```json
{
  "url": "https://diary.bikyu.dev/images/1234567890.jpg",
...
### アップロード後のURL（絶対URL）
- 形式: `https://diary.bikyu.dev/images/yyyymmddHHMMSS01.{拡張子}`
- 例: `https://diary.bikyu.dev/images/2026021000250001.jpg`
